...
public class ChatBox extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null) {
            // Accept the company name from JobDetailActivity
        ...
        // Set company name as chat title
    ...
    private void addMessageBubble(Message messageObject) {
        ...
        messageTextView.setTextColor(isMe ? ContextCompat.getColor(this, android.R.color.white)
        ...
        params.gravity = isMe ? android.view.Gravity.END : android.view.Gravity.START;
